  ...
  <pageBody class="bg-dark">
    <div style="max-width: 1400px; margin: 0 auto">
      ...
      <div class="text-white q-pa-sm">
        <h6>{{ podgrupaAmbijentaNaziv.toUpperCase() }}</h6>
        <p>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Sit
          voluptatem laudantium reprehenderit eum illum deserunt cumque maxime
          ipsam, quo quae distinctio a delectus beatae, sed voluptas aspernatur
          doloremque praesentium dignissimos?
        </p>
        <br />
            ...
            >
              <img
                ...
                :src="
                  ...
                  imageExt
                "
                @click="detaljiAmbijenta(proizvod, podgrupaAmbijentaImagePath)"
              />
